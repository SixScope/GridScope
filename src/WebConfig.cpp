...
String WebConfig::buildHtml() {
    ...
    html += "<style>body{font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;margin:20px;background:#121212;color:#eee;} .header{text-align:center;padding:20px 20px;margin-bottom:30px;background: linear-gradient(135deg, #2c3e50, #000);border-radius:15px;border-bottom: 4px solid #f39c12;} .logo-img{width:280px;height:auto;max-width:90%;border-radius:8px;} .card{background:#1e1e1e;padding:25px;border-radius:12px;max-width:550px;margin:auto;border:1px solid #333;box-shadow: 0 10px 20px rgba(0,0,0,0.3);} select{padding:12px;margin:8px 0;width:100%;background:#333;color:#fff;border:1px solid #444;border-radius:6px;} button{background:#f39c12;color:black;font-weight:bold;padding:15px;border:none;border-radius:6px;width:100%;cursor:pointer;margin-top:15px;transition:background 0.3s;} button:hover{background:#e67e22;} #log{background:#000;color:#00ff41;padding:15px;height:250px;overflow-y:scroll;font-family:'Consolas', monospace;font-size:13px;margin-top:25px;border:1px solid #444;border-radius:8px;line-height:1.4;}</style></head><body>";
